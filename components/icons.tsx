...
// Replaced with a new logo matching the image
export const LogoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill="none" {...props}>
        ...
        <path d="M50 15L25 27.5V40L50 52.5L75 40V27.5L50 15Z" fill="#6366F1"/>
        <path d="M25 45V65L50 77.5L75 65V45L50 57.5L25 45Z" fill="#4F46E5"/>
        <path d="M30 41.25V62.5L50 72.5L70 62.5V41.25L50 51.25L30 41.25Z" stroke="#C7D2FE" strokeWidth="3"/>
        <path d="M42 54V60" stroke="#C7D2FE" strokeWidth="3" strokeLinecap="round"/>
        <path d="M58 54V60" stroke="#C7D2FE" strokeWidth="3" strokeLinecap="round"/>
        <path d="M50 45L50 63" stroke="#C7D2FE" strokeWidth="3" strokeLinecap="round"/>
    </svg>
);

export const HomeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955a.75.75 0 011.06 0l8.955 8.955a.75.75 0 01-1.06 1.06l-.475-.475V21a.75.75 0 01-.75.75H5.25a.75.75 0 01-.75-.75V12.586l-.475.475a.75.75 0 01-1.06-1.06z" />
  </svg>
);

export const MarksEntryIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const AILearningHubIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const AIStudioIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6.75a3 3 0 00-3-3h-1.5a3 3 0 100 6h1.5a3 3 0 003-3z" />
  </svg>
);

export const AICBTIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const ResultGenerationIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 17.25v1.007a3 3 0 01-.879 2.122L7.5 21h9l-1.621-1.621A3 3 0 0115 18.257V17.25m6-12V15a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 15V5.25A2.25 2.25 0 015.25 3h4.5M15 3.75V2.25A2.25 2.25 0 0012.75 0h-3.5A2.25 2.25 0 007 2.25V3.75m-3.75 9h15" />
  </svg>
);
...
// New Icons for Header and Forms
...
export const PresentationChartBarIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5M9 11.25v1.5m3-1.5v1.5m3-1.5v1.5M12 11.25a.75.75 0 00-.75.75v3a.75.75 0 001.5 0v-3a.75.75 0 00-.75-.75z" />
    </svg>
);
...
export const Cog6ToothIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-1.226.55-.22 1.156-.22 1.706 0 .55.219 1.02.684 1.11 1.226l.043.25a2.25 2.25 0 013.486 1.12l.043.25c.09.542.56 1.007 1.11 1.226.55.22 1.156-.22 1.706 0 .55.219 1.02.684 1.11 1.226l.043-.25a2.25 2.25 0 013.486-1.12l.043-.25c.09-.542.56-1.007 1.11-1.226.55-.22 1.156-.22 1.706 0 .55.219 1.02.684 1.11 1.226l.043.25a2.25 2.25 0 01-1.12 3.486l-.25.043c-.542.09-1.007.56-1.226 1.11-.22.55-.22 1.156 0 1.706.219.55.684 1.02 1.226 1.11l.25.043a2.25 2.25 0 011.12 3.486l.25-.043c.542-.09 1.007-.56 1.226-1.11.22-.55.22-1.156 0-1.706-.219-.55-.684-1.02-1.226-1.11l-.25-.043a2.25 2.25 0 01-3.486-1.12l-.043-.25c-.09-.542-.56-1.007-1.11-1.226-.55-.22-1.156-.22-1.706 0-.55.219-1.02.684-1.11 1.226l-.043.25a2.25 2.25 0 01-3.486 1.12l-.043.25c-.09.542-.56-1.007-1.11-1.226-.55.22-1.156-.22-1.706 0-.55-.219-1.02-.684-1.11-1.226l-.043-.25a2.25 2.25 0 011.12-3.486l.25-.043c.542-.09 1.007-.56 1.226-1.11.22-.55.22-1.156 0 1.706-.219-.55-.684-1.02-1.226-1.11l-.25-.043a2.25 2.25 0 01-1.12-3.486l-.25.043c-.542.09-1.007.56-1.226 1.11-.22.55-.22-1.156 0 1.706.219.55.684 1.02 1.226 1.11l.25.043A2.25 2.25 0 019.594 3.94zM12 15a3 3 0 100-6 3 3 0 000 6z" />
    </svg>
);
...
export const IDCardIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h6m3-3.75l-3-3m0 0l-3 3m3-3v6.75m3-6.75v6.75m3-6.75v6.75M3 4.5h18A2.25 2.25 0 0123.25 6.75v10.5A2.25 2.25 0 0121 19.5H3A2.25 2.25 0 01.75 17.25V6.75A2.25 2.25 0 013 4.5z" />
  </svg>
);
...
export const GlobeAltIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 12h16.5m-16.5 0a8.963 8.963 0 013.33-7.018m1.288 14.036A8.963 8.963 0 013.75 12m16.5 0a8.963 8.963 0 00-3.33-7.018m-1.288 14.036A8.963 8.963 0 0016.5 12" />
    </svg>
);

export const ArrowTopRightOnSquareIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-4.5 0V6m0 0h.01M6.75 6.75H12m-1.5 6l5.25-5.25" />
    </svg>
);

// Kept for modals, not used in main UI now
...
export const SaveIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V8.25a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 8.25v8.25z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 17.25v-4.5a.75.75 0 01.75-.75h4.5a.75.75 0 01.75.75v4.5" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M6 3.75h12M12 3.75v3.75" />
    </svg>
);

export const CogIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5M12 9.75v4.5m-4.5-4.5v4.5m9-4.5v4.5M12 12a2.25 2.25 0 100-4.5 2.25 2.25 0 000 4.5z" />
    </svg>
);
...
export const PencilAltIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 19.82a2.25 2.25 0 01-1.06.607l-2.5 1.5a.75.75 0 01-.938-1.025l1.5-2.5a2.25 2.25 0 01.607-1.06L16.862 4.487z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12.75l-2.625 2.625" />
  </svg>
);
